...
using VandaliaHelpdesk.Helpers;
using VandaliaHelpdesk.Models;

namespace VandaliaHelpdesk.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> PresentationRequest()
        {
            ...
            try
            {
                ...
                VandaliaHelpdesk.Models.PresentationRequest request = CreatePresentationRequest( null, null );
        ...
        public VandaliaHelpdesk.Models.PresentationRequest CreatePresentationRequest( string stateId = null, string credentialType = null ) {
            VandaliaHelpdesk.Models.PresentationRequest request = new VandaliaHelpdesk.Models.PresentationRequest() {
                ...
                registration = new Registration() {
                    clientName = _configuration.GetValue("VerifiedID:client_name", "Vandalia Helpdesk"),
        ...
        public VandaliaHelpdesk.Models.PresentationRequest AddRequestedCredential( VandaliaHelpdesk.Models.PresentationRequest request
            ...
            request.requestedCredentials.Add( new RequestedCredential() {
                ...
                configuration = new VandaliaHelpdesk.Models.Configuration() {
        ...
        public bool IsFaceCheckRequested( VandaliaHelpdesk.Models.PresentationRequest request ) {
